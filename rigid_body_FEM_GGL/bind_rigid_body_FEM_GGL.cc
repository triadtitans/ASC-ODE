...
PYBIND11_MODULE(rigid_body_FEM_GGL, rbdggl) {
    ...
    auto m = rbdggl.def_submodule("bla", "basic linear algebra");
    ...
    py::class_<Connector>(rbdggl,"Connector", py::module_local())
    ...
    py::class_<Beam>(rbdggl,"Beam", py::module_local())
    ...
    py::class_<RigidBody_FEM> (rbdggl, "RigidBody_FEM_GGL")
      .def(py::init<>())
      ...
      //        return rbdggl.to_pickle();
      //    },
      //    [](py::tuple data){ // __setstate__
      //      RigidBody_FEM rbdggl;
    ...
    py::class_<RBS_FEM> (rbdggl, "RBS_FEM_GGL")
      .def(py::init<>())
